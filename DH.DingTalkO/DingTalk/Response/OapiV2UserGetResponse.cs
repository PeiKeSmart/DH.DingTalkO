...
public class DeptPositionDomain : TopObject
{
	        ...
	        /// 办公地点国际化字段
	        /// </summary>
	        [XmlElement("work_place_i18n")]
	        public string WorkPlaceI18n { get; set; }
}
...
public class UserGetResponseDomain : TopObject
{
	        ...
	        /// 扩展属性的国际化值
	        /// </summary>
	        [XmlElement("extension_i18n")]
	        public string ExtensionI18n { get; set; }
